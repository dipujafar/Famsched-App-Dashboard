    ...
    <div className="flex items-center justify-between w-[97%] font-poppins">
      ...
      <Flex align="center" gap={20}>
        ...
        <Link href={"/notifications"}>
          <div style={{ background: "linear-gradient(180deg, #3c353b 59.09%, #785e57 127.59%)" }} className="flex justify-center items-center size-12  rounded-full cursor-pointer relative border border-main-color">
